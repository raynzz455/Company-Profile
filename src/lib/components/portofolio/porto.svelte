...
<div class="mx-auto w-full h-auto">
  <div class="w-3/4 h-auto mx-auto "> 
      ...
      <!--Navbar-->
      <div class="w-3/4 h-auto mx-auto "> 
      <div class="mx-auto justify-center border h-[13vh]">
          <div class="relative mx-auto border w-3/4 h-[8vh] mt-[5vh] flex flex-wrap   ">
            <a href="/" class="group text-[#aeaeae] hover:text-orange-500 hover:fill-orange-500 flex-grow text-center h-full border flex flex-col items-center justify-center p-5">
            <div class="">
                ...
                <span class="mt-10 text-sm ">Branding Logo</span>  
            </div>
          </a>
                       
          <a href="/" class=" group text-[#aeaeae] hover:text-orange-500 hover:fill-orange-500 flex-grow text-center h-full border flex flex-col items-center justify-center p-5">
            <div class="">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-printer mx-auto border" viewBox="0 0 17 17">
                    <path d="M2.5 8a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1"/>
                    <path d="M5 1a2 2 0 0 0-2 2v2H2a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h1v1a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-1h1a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-1V3a2 2 0 0 0-2-2zM4 3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v2H4zm1 5a2 2 0 0 0-2 2v1H2a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1v-1a2 2 0 0 0-2-2zm7 2v3a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1"/>
                  </svg>
                  <span class="">PRINT MEDIA</span>
                </div>
                </a>
                <a href="/" class=" group text-[#aeaeae] hover:text-orange-500 hover:fill-orange-500 flex-grow text-center h-full border flex flex-col items-center justify-center p-5">
              <div class="">
                  ...
                  <span class="">DIGITAL PHOTO PRODUCT</span>
                </div>
              </a>
              <a href="/" class=" group text-[#aeaeae] hover:text-orange-500 hover:fill-orange-500 flex-grow text-center h-full border flex flex-col items-center justify-center p-5">
                <div class="">
      ...
      <!--Image-->
        <div class="mx-auto h-[100vh] border">
        <div class="relative mx-auto border w-3/4 ">
