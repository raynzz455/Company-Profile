      ...
      <div class="mx-auto max-w-8xl w-3/4 px-2 sm:px-6 lg:px-8">
          <div class="relative flex items-center justify-center"> <!-- Perubahan pada kelas ini -->
              <div class="mr-auto ml-10">
                  <a href="/">
                      <img class="w-40 h-21" src="{icon}" alt="Logo Icon" />
                  </a>
              </div>
              <div class="hidden sm:ml-30 sm:block">
                  <div class="flex space-x-12 px-10">
                      ...
                      <a href="/" class="group relative inline-block text-[#416731] kanit-semibold hover:text-[#428625] whitespace-nowrap text-base mt-2 pb-1">
                          Home
                      ...
                      <a href="/" class="group relative inline-block text-[#5a6c31] kanit-semibold hover:text-[#799B2C] whitespace-nowrap text-base mt-2 pb-1">
                          About Us
                          <!-- Pseudo-element untuk underline -->
                      ...
                      <a href="/" class="group relative inline-block text-[#cc832c] kanit-semibold hover:text-[#E1881E] whitespace-nowrap text-base mt-2 pb-1">
                          Portfolio
                          <!-- Pseudo-element untuk underline -->
                      ...
                      <a href="/" class="group relative inline-block text-[#f38928] kanit-semibold hover:text-[#F39A4A] whitespace-nowrap text-base mt-2 pb-1">
                          Contact
                          <!-- Pseudo-element untuk underline -->
