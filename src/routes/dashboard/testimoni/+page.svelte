    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-5">
      {#if data.comments.length > 0}
        {#each data.comments as comment}
          <div
            class="border-2 border-black rounded-lg w-full sm:w-[300px] h-auto mx-auto p-4 transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-[0px_10px_8px_black]"
          >
